...
* Developed by Group 9:
     ...
     * Dino Alfred Timbol
 * 
 * AuditLogRepository class. Deals with audit-log related
 * database operations
 **/
...
{
    public class AuditLogRepository : GenericRepository<AuditLog>, IAuditLogRepository //Extends Generic Repository (uses generic CRUD repository operations)
    {
